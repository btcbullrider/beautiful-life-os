...
export default function App() {
  const { gamification, saveGamification, showLevelUp, setShowLevelUp, levelUpData, setLevelUpData, animTrigger, setAnimTrigger, comboCount, recordCombo, xpFloat, setXpFloat, handlePrestige } = useGamification();
